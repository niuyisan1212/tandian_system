...
public interface ShopService extends IService<Shop> {
     ...
     * 分页查询店铺列表
     */
    Page<ShopVO> getShopPage(Integer pageNum, Integer pageSize, Integer visitStatus, String category, String keyword, Integer isValid, String expireTimeStart, String expireTimeEnd, Integer availableCount, String availableCountOp);
